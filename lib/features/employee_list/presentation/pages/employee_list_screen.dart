...
class _EmployeeListScreenState extends State<EmployeeListScreen> {
  ...
  Container _categoryHeader(String categoryName) {
    return Container(
  ...
  ListView _itemsList(List<dynamic> itemsInCategory) {
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Dismissible(
          ...
          onDismissed: (_) {
            bloc.add(ItemDismissedEvent(context: context, item: item));
          },
